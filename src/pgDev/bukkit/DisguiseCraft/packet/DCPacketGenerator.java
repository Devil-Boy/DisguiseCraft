...
import net.minecraft.server.v1_6_R1.Packet22Collect;
import net.minecraft.server.v1_6_R1.Packet23VehicleSpawn;
...
import net.minecraft.server.v1_6_R1.Packet32EntityLook;
import net.minecraft.server.v1_6_R1.Packet33RelEntityMoveLook;
import net.minecraft.server.v1_6_R1.Packet34EntityTeleport;
import net.minecraft.server.v1_6_R1.Packet35EntityHeadRotation;
import net.minecraft.server.v1_6_R1.Packet38EntityStatus;
